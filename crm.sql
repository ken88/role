...
INSERT INTO `department` VALUES ('7', '总经办');
INSERT INTO `department` VALUES ('8', '网招部');
INSERT INTO `department` VALUES ('9', '销售部');
INSERT INTO `department` VALUES ('10', '蓝打网');
INSERT INTO `department` VALUES ('11', '大客户部');
INSERT INTO `department` VALUES ('15', '测试部门');

-- ----------------------------
-- Table structure for departmentnumber
-- ----------------------------
DROP TABLE IF EXISTS `departmentnumber`;
CREATE TABLE `departmentnumber` (
  `departmentId` int(11) NOT NULL COMMENT '部门id',
  `number` int(11) NOT NULL DEFAULT 0 COMMENT '贡献值数量',
  PRIMARY KEY (`departmentId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='记录部门贡献值';

-- ----------------------------
-- Records of departmentnumber
-- ----------------------------
INSERT INTO `departmentnumber` VALUES ('1', '3');
INSERT INTO `departmentnumber` VALUES ('7', '2');
INSERT INTO `departmentnumber` VALUES ('8', '8');
INSERT INTO `departmentnumber` VALUES ('11', '1');
INSERT INTO `departmentnumber` VALUES ('12', '0');
...
CREATE TABLE `log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `messages` varchar(100) NOT NULL COMMENT '操作说明',
...
CREATE TABLE `module` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `moduleName` varchar(50) NOT NULL COMMENT '菜单名',
  `pid` int(11) NOT NULL COMMENT '父级id',
  `bpath` varchar(50) NOT NULL COMMENT '级别结构',
  `url` varchar(200) NOT NULL COMMENT '菜单地址',
  `isBut` tinyint(2) NOT NULL DEFAULT 0 COMMENT '是否是按钮 0是 1不是',
  PRIMARY KEY (`id`)
...
-- Records of module
-- ----------------------------
INSERT INTO `module` VALUES ('1', '系统设置', '0', '0', '0', '1');
INSERT INTO `module` VALUES ('2', '菜单管理', '1', '0-1', '/module/index', '1');
INSERT INTO `module` VALUES ('3', '新增', '2', '0-1-2', '/module/add', '0');
INSERT INTO `module` VALUES ('4', '编辑', '2', '0-1-2', '/module/edit', '0');
INSERT INTO `module` VALUES ('5', '删除', '2', '0-1-2', '/module/delete', '0');
INSERT INTO `module` VALUES ('14', '部门管理', '1', '0-1', '/department/index', '1');
INSERT INTO `module` VALUES ('15', '新增', '14', '0-1-14', '/department/add', '0');
INSERT INTO `module` VALUES ('16', '编辑', '14', '0-1-14', '/department/edit', '0');
INSERT INTO `module` VALUES ('17', '删除', '14', '0-1-14', '/department/delete', '0');
INSERT INTO `module` VALUES ('18', '账号管理', '1', '0-1', '/user/index', '1');
INSERT INTO `module` VALUES ('19', '新增', '18', '0-1-18', '/user/add', '0');
INSERT INTO `module` VALUES ('20', '编辑', '18', '0-1-18', '/user/edit', '0');
INSERT INTO `module` VALUES ('21', '删除', '18', '0-1-18', '/user/delete', '0');
INSERT INTO `module` VALUES ('26', '角色管理', '1', '0-1', '/role/index', '1');
INSERT INTO `module` VALUES ('27', '新增', '26', '0-1-26', '/role/add', '0');
INSERT INTO `module` VALUES ('28', '编辑', '26', '0-1-26', '/role/edit', '0');
INSERT INTO `module` VALUES ('29', '删除', '26', '0-1-26', '/role/delete', '0');
INSERT INTO `module` VALUES ('30', '角色授权', '26', '0-1-26', '/acl/index', '0');
INSERT INTO `module` VALUES ('37', '日志管理', '0', '0', '0', '1');
INSERT INTO `module` VALUES ('38', '操作日志', '37', '0-37', '/log/index', '1');
INSERT INTO `module` VALUES ('39', '简历管理', '0', '0', '0', '1');
INSERT INTO `module` VALUES ('40', '简历列表', '39', '0-39', '/resume/index', '1');
INSERT INTO `module` VALUES ('41', '新增', '40', '0-39-40', '/resume/add', '0');
INSERT INTO `module` VALUES ('42', '编辑', '40', '0-39-40', '/resume/edit', '0');
INSERT INTO `module` VALUES ('43', '删除', '40', '0-39-40', '/resume/delete', '0');
INSERT INTO `module` VALUES ('44', '分类管理', '0', '0', '0', '1');
INSERT INTO `module` VALUES ('45', '岗位分类', '44', '0-44', '/resume-category/index', '1');
INSERT INTO `module` VALUES ('46', '新增', '45', '0-44-45', '/resume-category/add', '0');
INSERT INTO `module` VALUES ('47', '编辑', '45', '0-44-45', '/resume-category/edit', '0');
INSERT INTO `module` VALUES ('48', '删除', '45', '0-44-45', '/resume-category/delete', '0');
INSERT INTO `module` VALUES ('49', '导入', '40', '0-39-40', '/resume/pour-excel', '1');
INSERT INTO `module` VALUES ('50', '投放公海', '40', '0-39-40', '/resume/out-info', '0');
INSERT INTO `module` VALUES ('51', '公海简历', '39', '0-39', '/gong-hai/index', '1');
INSERT INTO `module` VALUES ('52', '分配', '51', '0-39-51', '/gong-hai/fen-pei', '0');
INSERT INTO `module` VALUES ('53', '密码修改', '1', '0-1', '/user/pass', '1');
INSERT INTO `module` VALUES ('55', '是非得失', '0', '0', '0', '1');
...
CREATE TABLE `resume` (
  ...
  `sex` int(1) DEFAULT 1 COMMENT '性别1男2女',
  `phone` char(11) NOT NULL DEFAULT '0' COMMENT '手机号',
  `isMiHao` int(4) DEFAULT 0 COMMENT '是否秘号 1是0不是',
  `age` int(4) DEFAULT 0 COMMENT '年龄',
  `xueLi` varchar(20) DEFAULT '' COMMENT '最高学历',
  `rcName1` varchar(20) DEFAULT '' COMMENT '岗位分类1',
  `rcId1` int(11) DEFAULT NULL COMMENT '岗位分类id1',
  `rcName2` varchar(20) DEFAULT '' COMMENT '岗位分类2',
  `rcId2` int(11) DEFAULT NULL COMMENT '岗位分类id2',
  `qiWangDiDian` varchar(30) DEFAULT '' COMMENT '期望地点',
  `qiWangXinZi` varchar(20) DEFAULT '' COMMENT '期望薪资',
  `juZhuDiZhi` varchar(100) DEFAULT '' COMMENT '居住地址',
  `huJiDiZhi` varchar(100) DEFAULT '' COMMENT '户籍地址',
  `mianMao` varchar(20) DEFAULT '' COMMENT '政治面貌',
  `qq` char(11) DEFAULT '' COMMENT 'qq',
  `weiXin` varchar(30) DEFAULT NULL,
  `lianXiRen` varchar(30) DEFAULT '' COMMENT '紧急联系人',
  `lianXiRenPhone` char(11) DEFAULT '' COMMENT '紧急联系人电话',
  `hunYin` int(1) DEFAULT 0 COMMENT '婚姻状况 0未婚1已婚2丧偶',
  `minZu` varchar(10) DEFAULT '' COMMENT '民族',
  `chuShengRiQi` varchar(20) DEFAULT '' COMMENT '出生日期',
  `shenFenZheng` varchar(18) DEFAULT '' COMMENT '身份证',
  `zhuanYe` varchar(20) DEFAULT '' COMMENT '专业',
  `email` varchar(50) DEFAULT '' COMMENT '邮件',
  `yinHang` varchar(50) DEFAULT '' COMMENT '银行',
  `kaiHuWangDian` varchar(50) DEFAULT '' COMMENT '开户网点',
  `yinHangNum` varchar(30) DEFAULT '' COMMENT '银行卡号',
  `uid` int(11) NOT NULL COMMENT '操作人id',
  `departmentId` int(11) NOT NULL COMMENT '部门id',
  `gongZuoJingLi` varchar(8000) DEFAULT '' COMMENT '工作经历',
  `level` int(2) NOT NULL COMMENT '级别',
  `createTime` datetime DEFAULT current_timestamp() COMMENT '创建时间',
  `isGongHai` int(1) NOT NULL DEFAULT 0 COMMENT '是否公海简历 1是0不是',
  `beizhu` varchar(50) DEFAULT NULL COMMENT '备注',
  `path` varchar(100) NOT NULL DEFAULT '' COMMENT '层级',
  PRIMARY KEY (`id`),
  UNIQUE KEY `phone` (`phone`),
  KEY `isGongHai` (`isGongHai`),
  KEY `path` (`path`),
  KEY `departmentId` (`departmentId`)
) ENGINE=InnoDB AUTO_INCREMENT=15027 DEFAULT CHARSET=utf8 COMMENT='简历表';

-- ----------------------------
-- Records of resume
-- ----------------------------
INSERT INTO `resume` VALUES ('218', '王昭君', '1', '18701244569', '0', null, '高中', '服务员/收银员', '10', '服务员', '12', '上海市长宁区', '1000~3000', '', '', '', '', '', '', '', '0', '', '', '', '', '', '天津银行', '', '', '44', '8', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '5', '2018-05-29 08:13:29', '0', '', '1-35-36-37-38-44');
INSERT INTO `resume` VALUES ('219', '王五', '1', '13154875465', '0', null, '初中', '0', null, '0', null, '', '1000~3000', '', '', '', '', '', '', '', '0', '', '', '', '', '', '中国银行', '', '', '44', '8', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '5', '2018-05-29 08:14:00', '0', '', '1-35-36-37-38-44');
INSERT INTO `resume` VALUES ('220', '王五', '2', '15041546589', '0', null, '初中', '0', null, '0', null, '', '1000~3000', '', '', '', '', '', '', '', '0', '', '', '', '', '', '汉口银行', '', '', '46', '8', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '5', '2018-05-29 08:14:29', '1', '', '1-35-36-37-39-46');
INSERT INTO `resume` VALUES ('221', '问问', '1', '13361450865', '0', '33', '初中', '零售/导购', '8', '理货员', '29', '浙江省衢州市市辖区', '1000~3000', '3日发放投放额头发4恶人', '儿童歌热熔封测人工费', '通风柜粉条 ', '125487936', '他跟我5题', '违规如果色提高', '6845135', '1', '汉', '2018-05-16', '370725199502041111', '4歌舞团给我干活', '820758509@qq.com', '中国银行', '让他担任股份', '496851698462222', '45', '8', '{\"1\":{\"shijian1\":\"2018-08 - 2018-12\",\"qiye1\":\"35让他人防\",\"gangwei1\":\"沃特股份v\"},\"2\":{\"shijian2\":\"2018-01 - 2018-05\",\"qiye2\":\"54儿童荣国府儿\",\"gangwei2\":\"二胎人GV沃尔特\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '5', '2018-05-29 08:14:40', '1', '5各位饿提高服务s', '1-35-36-37-38-45');
INSERT INTO `resume` VALUES ('222', '粑粑粑粑吧', '1', '15145645789', '0', '23', '初中', '淘宝招聘', '4', '淘宝客服', '7', '上海市宝山区', '1000~3000', '我发在阿尔答复在二姑夫而是对方', '无日峰输入法', '群众', '845652136', '5他额铜仁', '是v', '15121158589', '0', '黎族', '2018-05-01', '125486599521546887', '热热GV', '820758509@qq.com', '北京银行', '', '1564852516485133', '1', '8', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '10', '2018-05-29 08:19:40', '0', '', '1');
INSERT INTO `resume` VALUES ('4635', '贾飞祥', '2', '13100000001', '1', '20', '大专', '服务员/收银员', '10', '旅游顾问', '25', '', '', '上海', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '1', '1', '', '10', '2018-05-29 20:35:05', '0', '通知今天下午面试', '1');
INSERT INTO `resume` VALUES ('4636', '李长清', '2', '13166309007', '1', '25', '高中', '服务员/收银员', '10', '签证专员', '24', '', '', '上海', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '1', '1', '', '10', '2018-05-29 20:35:05', '0', '不考虑', '1');
INSERT INTO `resume` VALUES ('4637', '李光耀', '2', '17821503431', '1', '24', '大专', '服务员/收银员', '10', '导游', '23', '', '', '上海', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '1', '1', '', '10', '2018-05-29 20:35:05', '0', '考虑一下', '1');
INSERT INTO `resume` VALUES ('4638', '何嗣同', '2', '18895685718', '0', '22', '高中', '淘宝招聘', '4', '淘宝美工', '6', '', '', '上海宝安公路', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '1', '1', '', '10', '2018-05-29 20:35:05', '0', '考虑一下', '1');
INSERT INTO `resume` VALUES ('4639', '许超', '2', '17821504290', '1', '24', '大专', '淘宝招聘', '4', '淘宝美工', '6', '', '', '上海嘉定', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '1', '1', '', '10', '2018-05-29 20:35:05', '0', '通知今天下午面试', '1');
INSERT INTO `resume` VALUES ('4640', '张佳琪', '2', '13621849083', '1', '23', '高中', '淘宝招聘', '4', '淘宝美工', '6', '', '', '上海宝山', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '1', '1', '', '10', '2018-05-29 20:35:05', '0', '未接通', '1');
INSERT INTO `resume` VALUES ('4641', '孙校华', '2', '18155820262', '0', '19', '大专', '淘宝招聘', '4', '淘宝客服', '7', '', '', '上海宝山', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '1', '1', '', '10', '2018-05-29 20:35:05', '0', '未接通', '1');
INSERT INTO `resume` VALUES ('10721', '1234', '1', '15045147879', '1', '2000', '中专', '零售/导购', '8', '导购员', '28', '内蒙古自治区赤峰市巴林右旗', '7000以上', '', '', '111', '1111', '111', '111', '1111', '1', '1111', '', '', '111', '111', '中信银行', '111', '', '39', '8', '{\"1\":{\"shijian1\":\"2018-02 - 2019-07\",\"qiye1\":\"111\",\"gangwei1\":\"1111\"},\"2\":{\"shijian2\":\"2018-07 - 2018-10\",\"qiye2\":\"111\",\"gangwei2\":\"111\"},\"3\":{\"shijian3\":\"2018-07 - 2018-09\",\"qiye3\":\"11\",\"gangwei3\":\"111\"}}', '6', '2018-05-29 22:26:33', '1', '111', '1-35-36-37-39');
INSERT INTO `resume` VALUES ('10722', 'wangwu', '2', '15145695412', '1', null, '初中', '服务员/收银员', '10', '服务员', '12', '山东省德州市平原县', '3000~5000', '', '', '', '', '', '', '', '1', '', '', '', '', '', '兴业银行', '', '', '39', '8', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '6', '2018-05-29 22:27:49', '1', '', '1-35-36-37-39');
INSERT INTO `resume` VALUES ('13425', 'rtgrtg', '1', '13000000000', '0', null, '初中', '0', null, '0', null, '', '1000~3000', '', '', '', '', '', '', '', '0', '', '', '', '', '', '中国银行', '', '', '54', '11', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '8', '2018-05-29 23:14:13', '1', '', '1-35-54');
INSERT INTO `resume` VALUES ('14722', '李金昌', '2', '13150085529', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14723', '高勤生', '2', '15502196201', '1', '0', '高中以下', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14724', '黄义波', '2', '13650947446', '1', '24', '高中', '服务员/收银员', '10', '导游', '23', '', '', '上海', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '考虑一下', '1-35-36');
INSERT INTO `resume` VALUES ('14725', '王新路', '2', '18721656864', '1', '22', '高中', '淘宝招聘', '4', '淘宝美工', '6', '', '', '上海宝安公路', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '考虑一下', '1-35-36');
INSERT INTO `resume` VALUES ('14726', '张帅', '2', '18656458326', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14727', '蔡朋朋', '2', '17612113740', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('
'1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14956', '肖体俊', '2', '18282881361', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14957', '张伟伟', '2', '13683117688', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14958', '章彩玲', '2', '13156618266', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14959', '苏宁', '2', '15800665674', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14960', '张健', '2', '18860454161', '1', '0', '本科', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14961', '郭盼红', '2', '13892576271', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14962', '胡青云', '2', '17621527804', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14963', '王国豪', '2', '18217244880', '1', '0', '高中以下', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14964', '吴余旭', '2', '15157238175', '1', '0', '高中以下', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14965', '肖河清', '2', '17784433413', '1', '0', '高中以下', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14966', '周冰倩', '2', '15921853261', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14967', '张文端', '2', '17710382031', '1', '0', '高中以下', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14968', '胡恩梅', '2', '15921160182', '1', '0', '高中以下', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14969', '刘欢', '2', '13788995394', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14970', '王蒙恩', '2', '13961586483', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14971', '俞颖', '2', '13524342685', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14972', '曹婉', '2', '17755752279', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14973', '杨旭生', '2', '18009360439', '1', '0', '大专', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14974', '高逍飞', '2', '13162712363', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14975', '徐佳', '2', '13917239431', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14976', '刘璐', '2', '13889132937', '1', '0', '大专', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14977', '丁菁', '2', '13701924211', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14978', '黄智霖', '2', '17621103984', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14979', '杜曼', '2', '13120691303', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('14980', '魏高梁', '2', '15601916862', '1', '0', '高中', '', '0', '', '0', '', '', '', '', '', '', null, '', '', '0', '', '', '', '', '', '', '', '', '36', '8', '', '8', '2018-05-30 11:35:58', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('15009', '12321', '1', '13123444444', '0', null, '初中', '0', null, '0', null, '', '1000~3000', '', '', '', '', '', '', '', '0', '', '', '', '', '', '中国银行', '', '', '36', '8', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '8', '2018-05-29 23:51:59', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('15010', 'ggg', '1', '13122233333', '0', null, '初中', '0', null, '0', null, '', '1000~3000', '', '', '', '', '', '', '', '0', '', '', '', '', '', '中国银行', '', '', '36', '8', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '8', '2018-05-29 23:52:16', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('15011', '123', '1', '13123123123', '0', null, '初中', '0', null, '0', null, '', '1000~3000', '', '', '', 'sfsdfsdfaf', '', '', '', '0', '1', '', '', '', '', '中国银行', '', '', '36', '8', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '8', '2018-05-29 23:54:33', '0', '', '1-35-36');
INSERT INTO `resume` VALUES ('15012', '12313', '1', '13122233445', '0', null, '初中', '0', null, '0', null, '', '1000~3000', '', '', '', '12321312321', '123213213211232132132132132132', '', '', '0', '1232132131', '2018-05-30', '213213213213213213', '123213213', '213213213123123', '中国银行', '21321', '11111111111111111111', '1', '1', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '10', '2018-05-30 01:30:56', '0', '12312', '1');
INSERT INTO `resume` VALUES ('15013', '666', '2', '18764353253', '1', null, '技校', '服务员/收银员', '10', '服务员', '12', '江西省九江市都昌县', '3000~5000', '', '', '', '', '', '', '', '1', '', '', '', '', '', '中信银行', '', '', '57', '11', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"2018-06 - 2021-08\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"2016-02 - 2018-07\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '7', '2018-05-30 01:59:51', '1', '', '1-35-54-57');
INSERT INTO `resume` VALUES ('15014', '嗯嗯嗯', '1', '13361450854', '0', '33', '高中', '淘宝招聘', '4', '淘宝客服', '7', '安徽省亳州市蒙城县', '3000~5000', '我认识他的GV生日蛋糕', '我是认同的岗位人员提供不', '党员', '89451289456', '', '人提供福', '74125845632', '1', '汉', '2018-05-02', '147852369632587412', '', '78945123@qq.com', '中国银行', '', '', '55', '12', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '8', '2018-05-30 02:10:51', '1', '', '1-35-55');
INSERT INTO `resume` VALUES ('15015', 'sdf', '1', '15031231242', '0', null, '初中', '0', null, '0', null, '', '1000~3000', '', '', '', '', '', '', '', '0', '', '', '', '', '', '中国银行', '', '', '55', '12', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '8', '2018-05-30 02:11:05', '0', '', '1-35-55');
INSERT INTO `resume` VALUES ('15016', '2113', '1', '15054456456', '0', null, '初中', '0', null, '0', null, '天津市河东区', '1000~3000', '', '', '', '', '', '', '', '0', '', '', '', '', '', '兴业银行', '', '', '55', '12', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '8', '2018-05-30 02:11:22', '0', '', '1-35-55');
INSERT INTO `resume` VALUES ('15017', '545234', '1', '13123434323', '0', null, '初中', '服务员/收银员', '10', '服务员', '12', '江西省景德镇市市辖区', '1000~3000', '', '', '', '', '', '', '', '0', '', '', '', '', '', '浦发银行', '', '', '60', '12', '{\"1\":{\"shijian1\":\"2014-02 - 2018-06\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"2018-05 - 2018-06\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"2018-01 - 2018-06\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '7', '2018-05-30 02:33:24', '0', '', '1-35-55-60');
INSERT INTO `resume` VALUES ('15018', '0531-1', '1', '13014564131', '0', null, '初中', '0', null, '0', null, '', '1000~3000', '', '', '', '', '', '', '', '0', '', '', '', '', '', '中国银行', '', '', '41', '8', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '5', '2018-05-30 21:07:06', '1', '', '1-35-36-37-39-41');
INSERT INTO `resume` VALUES ('15019', '0531-2', '2', '13054678144', '1', null, '初中', '0', null, '0', null, '', '1000~3000', '', '', '', '', '', '', '', '0', '', '', '', '', '', '中国银行', '', '', '61', '12', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '7', '2018-05-30 21:07:28', '0', '', '1-35-55-61');
INSERT INTO `resume` VALUES ('15020', '0531-3', '2', '13016413226', '0', null, '初中', '0', null, '0', null, '', '1000~3000', '', '', '', '', '', '', '', '0', '', '', '', '', '', '中国银行', '', '', '61', '12', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '7', '2018-05-30 21:07:43', '0', '', '1-35-55-61');
INSERT INTO `resume` VALUES ('15021', '0531-4', '2', '18716541325', '1', null, '初中', '0', null, '0', null, '', '1000~3000', '', '', '', '', '', '', '', '0', '', '', '', '', '', '中国银行', '', '', '41', '8', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '5', '2018-05-30 21:08:08', '0', '', '1-35-36-37-39-41');
INSERT INTO `resume` VALUES ('15022', 'test0531-3', '1', '15021651464', '0', null, '初中', '0', null, '0', null, '', '1000~3000', '', '', '', '', '', '', '', '0', '', '', '', '', '', '中国银行', '', '', '61', '12', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '7', '2018-05-30 21:13:29', '1', '', '1-35-55-61');
INSERT INTO `resume` VALUES ('15023', 'test0531-2', '1', '15014961326', '1', null, '初中', '0', null, '0', null, '', '1000~3000', '', '', '', '', '', '', '', '0', '', '', '', '', '', '中国银行', '', '', '61', '12', '{\"1\":{\"shijian1\":\"2018-05 - 2018-06\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '7', '2018-05-30 21:13:49', '0', '', '1-35-55-61');
INSERT INTO `resume` VALUES ('15024', 'test0531-1', '1', '13014965416', '1', null, '初中', '0', null, '0', null, '', '1000~3000', '', '', '', '', '', '', '', '0', '', '', '', '', '', '中国银行', '', '', '61', '12', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '7', '2018-05-30 21:14:00', '0', '', '1-35-55-61');
INSERT INTO `resume` VALUES ('15025', 'test0531-4', '1', '13014961432', '0', null, '初中', '0', null, '0', null, '', '1000~3000', '', '', '', '', '', '', '', '0', '', '', '', '', '', '中国银行', '', '', '61', '12', '{\"1\":{\"shijian1\":\"2018-04 - 2018-06\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"2018-01 - 2018-06\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"2018-02 - 2018-06\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '7', '2018-05-30 21:14:30', '0', '', '1-35-55-61');
INSERT INTO `resume` VALUES ('15026', '12312', '1', '13122544565', '0', null, '初中', '0', null, '0', null, '', '1000~3000', '', '', '', '', '', '', '', '0', '', '', '', '', '', '中国银行', '', '', '1', '1', '{\"1\":{\"shijian1\":\"\",\"qiye1\":\"\",\"gangwei1\":\"\"},\"2\":{\"shijian2\":\"\",\"qiye2\":\"\",\"gangwei2\":\"\"},\"3\":{\"shijian3\":\"\",\"qiye3\":\"\",\"gangwei3\":\"\"}}', '10', '2018-06-01 10:50:11', '0', '', '1');

-- ----------------------------
-- Table structure for resumecategory
-- ----------------------------
DROP TABLE IF EXISTS `resumecategory`;
CREATE TABLE `resumecategory` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cName` varchar(30) NOT NULL COMMENT '岗位名',
  `pid` int(11) NOT NULL COMMENT '父级id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='岗位分类';

-- ----------------------------
-- Records of resumecategory
-- ----------------------------
INSERT INTO `resumecategory` VALUES ('4', '淘宝招聘', '0');
INSERT INTO `resumecategory` VALUES ('6', '淘宝美工', '4');
INSERT INTO `resumecategory` VALUES ('7', '淘宝客服', '4');
INSERT INTO `resumecategory` VALUES ('8', '零售/导购', '0');
INSERT INTO `resumecategory` VALUES ('9', '导购', '8');
INSERT INTO `resumecategory` VALUES ('10', '服务员/收银员', '0');
INSERT INTO `resumecategory` VALUES ('11', '收银员', '10');
INSERT INTO `resumecategory` VALUES ('12', '服务员', '10');
INSERT INTO `resumecategory` VALUES ('13', '客服专员', '10');
INSERT INTO `resumecategory` VALUES ('15', '前台/迎宾', '10');
INSERT INTO `resumecategory` VALUES ('16', '订票员', '10');
INSERT INTO `resumecategory` VALUES ('17', '行李员', '10');
INSERT INTO `resumecategory` VALUES ('18', '加油员', '10');
INSERT INTO `resumecategory` VALUES ('19', '乘务员', '10');
INSERT INTO `resumecategory` VALUES ('20', '礼仪小姐', '10');
INSERT INTO `resumecategory` VALUES ('21', '领班', '10');
INSERT INTO `resumecategory` VALUES ('22', '大堂', '10');
INSERT INTO `resumecategory` VALUES ('23', '导游', '10');
INSERT INTO `resumecategory` VALUES ('24', '签证专员', '10');
INSERT INTO `resumecategory` VALUES ('25', '旅游顾问', '10');
INSERT INTO `resumecategory` VALUES ('27', '促销员', '8');
INSERT INTO `resumecategory` VALUES ('28', '导购员', '8');
INSERT INTO `resumecategory` VALUES ('29', '理货员', '8');
INSERT INTO `resumecategory` VALUES ('30', '防损员', '8');
INSERT INTO `resumecategory` VALUES ('32', '督导', '8');
INSERT INTO `resumecategory` VALUES ('33', '品类管理员', '8');
...
CREATE TABLE `role` (
  ...
  `departmentId` int(11) NOT NULL COMMENT '部门id',
  `acl` text DEFAULT NULL COMMENT '角色权限',
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES ('1', '技术系统管理员', '1', '1', '1,14,15,16,17,18,19,20,21,2,3,4,5,26,27,28,29,30,53,37,38,39,40,41,42,43,49,50,51,52,44,45,46,47,48', '10', '1');
INSERT INTO `role` VALUES ('63', '超级管理员', '1', '1', '1,14,15,16,17,18,19,20,21,26,27,28,29,30,53,39,40,41,42,43,49,50,51,52,44,45,46,47,48', '9', '1-63');
INSERT INTO `role` VALUES ('64', '项目交付部总监', '35', '7', '1,14,15,16,17,18,19,20,21,26,27,28,29,30,53,39,40,41,42,43,49,50,51,52,44,45,47,48', '8', '1-63-64');
INSERT INTO `role` VALUES ('65', '网招部经理', '36', '8', '1,18,19,20,26,27,28,30,53,39,40,41,42,49,50,51', '7', '1-63-64-65');
INSERT INTO `role` VALUES ('66', '主管1', '37', '8', '40', '6', '1-63-64-65-66');
INSERT INTO `role` VALUES ('67', '主管2', '37', '8', '1,18,19,20,26,27,28,30,53,39,40,41,42,49,50,51', '6', '1-63-64-65-67');
INSERT INTO `role` VALUES ('68', '招聘专员', '39', '8', '53,39,40,41,42,49,50,51', '5', '1-63-64-65-67-68');
INSERT INTO `role` VALUES ('69', '专员1', '38', '8', '39,40,41,42,49,50,51', '5', '1-63-64-65-66-69');
INSERT INTO `role` VALUES ('70', '项目一组组员', '38', '8', '39,40,41,42,49,50,51', '5', '1-63-64-65-66-70');
INSERT INTO `role` VALUES ('71', '项目交付部总监', '44', '8', '1,18,19,20,26,27,28,30,53,39,40,41,42,49,50,51', '4', '1-63-64-65-66-71');
INSERT INTO `role` VALUES ('72', '苏州交付中心总监', '35', '7', '1,18,19,20,21,26,27,28,29,30,53,39,40,41,42,43,49,50,51,52,44,45,46,47,48', '8', '1-63-72');
INSERT INTO `role` VALUES ('73', '大客户部总经理', '35', '7', '1,18,19,20,21,26,27,28,29,30,53,39,40,41,42,43,49,50,51,52,44,45,46,47,48', '8', '1-63-73');
INSERT INTO `role` VALUES ('74', '蓝打网总经理', '35', '7', '1,18,19,20,21,26,27,28,29,30,53,39,40,41,42,43,49,50,51,52,44,45,46,47,48', '8', '1-63-74');
INSERT INTO `role` VALUES ('75', '大客户运营一部总监', '54', '11', '1,26,27,28,29,30,53,39,40,41,42,43,49,50,51,44,45,46,47,48', '7', '1-63-73-75');
INSERT INTO `role` VALUES ('76', '大客户运营二部总监', '54', '11', '1,26,27,28,29,30,53,39,40,41,42,43,49,50,51,44,45,46,47,48', '7', '1-63-73-76');
INSERT INTO `role` VALUES ('77', '大客户运营三部总监', '54', '11', '1,26,27,28,29,30,53,39,40,41,42,43,49,50,51,44,45,46,47,48', '7', '1-63-73-77');
INSERT INTO `role` VALUES ('78', '大客户销售一部总监', '54', '11', null, '7', '1-63-73-78');
INSERT INTO `role` VALUES ('79', '大客户销售二部总监', '54', '11', '1,26,27,28,29,30,53,39,40,41,42,43,49,50,51,44,45,46,47,48', '7', '1-63-73-79');
INSERT INTO `role` VALUES ('80', '经理1', '55', '12', '1,14,15,16,17,18,19,20,21,2,3,4,5,26,27,28,29,30,53,37,38,39,40,41,42,43,49,50,51,52,44,45,46,47,48', '7', '1-63-72-80');
INSERT INTO `role` VALUES ('82', '主管-交1', '55', '12', '1,14,15,16,17,18,19,20,21,2,3,4,5,26,27,28,29,30,53,37,38,39,40,41,42,43,49,50,51,52,44,45,46,47,48', '7', '1-63-72-82');
INSERT INTO `role` VALUES ('83', '主管-交2', '55', '12', null, '7', '1-63-72-83');
INSERT INTO `role` VALUES ('84', '招聘专员-交', '55', '12', '39,40,41,42,49,50,51', '7', '1-63-72-84');
...
CREATE TABLE `user` (
  ...
  `departmentId` int(11) NOT NULL COMMENT '部门id',
  `departmentName` varchar(50) NOT NULL COMMENT '部门名',
  `realName` varchar(50) NOT NULL DEFAULT '' COMMENT '员工姓名',
  `createDate` datetime NOT NULL COMMENT '录入时间',
  `roleId` int(11) NOT NULL COMMENT '角色id',
  `roleName` varchar(30) NOT NULL COMMENT '角色名',
  `path` varchar(200) NOT NULL DEFAULT '' COMMENT '层级',
  `level` int(10) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `username` (`username`),
  KEY `path` (`path`)
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8 COMMENT='用户登录表';

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '1', '技术部', 'ken', '2018-05-29 16:43:15', '1', '技术系统管理员', '1', '10');
INSERT INTO `user` VALUES ('35', 'baoshan', '388ec3e3fa4983032b4f3e7d8fcb65ad', '7', '总经办', '宝山', '2018-05-29 07:25:55', '63', '超级管理员', '1-35', '9');
INSERT INTO `user` VALUES ('36', 'zoubin', 'e10adc3949ba59abbe56e057f20f883e', '8', '网招部', '邹彬', '2018-05-29 07:29:42', '64', '项目交付部总监', '1-35-36', '8');
INSERT INTO `user` VALUES ('37', 'zhangsan', 'e10adc3949ba59abbe56e057f20f883e', '8', '网招部', '张三', '2018-05-29 07:33:42', '65', '网招部经理', '1-35-36-37', '7');
INSERT INTO `user` VALUES ('38', 'lisi', 'e10adc3949ba59abbe56e057f20f883e', '8', '网招部', '李四', '2018-05-29 07:57:13', '82', '主管-交1', '1-35-36-37-38', '6');
INSERT INTO `user` VALUES ('39', 'wangwu', '96e79218965eb72c92a549dd5a330112', '8', '网招部', '王五', '2018-05-29 07:57:25', '67', '主管2', '1-35-36-37-39', '6');
INSERT INTO `user` VALUES ('40', 'emp_001', 'e10adc3949ba59abbe56e057f20f883e', '8', '网招部', '王伟', '2018-05-29 08:00:06', '68', '招聘专员', '1-35-36-37-39-40', '5');
INSERT INTO `user` VALUES ('41', 'emp_002', 'e10adc3949ba59abbe56e057f20f883e', '8', '网招部', '李伟', '2018-05-29 08:01:07', '68', '招聘专员', '1-35-36-37-39-41', '5');
INSERT INTO `user` VALUES ('42', '王八蛋', 'e10adc3949ba59abbe56e057f20f883e', '8', '网招部', '哈哈哈', '2018-05-29 08:01:21', '69', '专员1', '1-35-36-37-38-42', '5');
INSERT INTO `user` VALUES ('43', 'emp_003', 'e10adc3949ba59abbe56e057f20f883e', '8', '网招部', '王伟', '2018-05-29 08:01:29', '68', '招聘专员', '1-35-36-37-39-43', '5');
INSERT INTO `user` VALUES ('44', '王二麻子', 'e10adc3949ba59abbe56e057f20f883e', '8', '网招部', '巴啦啦', '2018-05-29 08:02:00', '66', '主管1', '1-35-36-37-38-44', '6');
INSERT INTO `user` VALUES ('45', '马大哈', 'e10adc3949ba59abbe56e057f20f883e', '8', '网招部', '五六七', '2018-05-29 08:03:33', '70', '项目一组', '1-35-36-37-38-45', '5');
INSERT INTO `user` VALUES ('46', 'emp_004', 'e10adc3949ba59abbe56e057f20f883e', '8', '网招部', '赵伟', '2018-05-29 08:04:06', '68', '招聘专员', '1-35-36-37-39-46', '4');
INSERT INTO `user` VALUES ('47', 'emp_005', 'e10adc3949ba59abbe56e057f20f883e', '8', '网招部', '郑伟', '2018-05-29 08:08:52', '68', '招聘专员', '1-35-36-37-39-46-47', '4');
INSERT INTO `user` VALUES ('48', 'liuyifei', 'e10adc3949ba59abbe56e057f20f883e', '8', '网招部', '刘亦菲', '2018-05-29 22:21:13', '71', '项目交付部总监', '1-35-36-37-38-44-48', '8');
INSERT INTO `user` VALUES ('49', 'yangmi', 'e10adc3949ba59abbe56e057f20f883e', '8', '网招部', '杨幂', '2018-05-29 22:21:35', '70', '项目一组组员', '1-35-36-37-38-44-49', '5');
INSERT INTO `user` VALUES ('50', 'mayun', 'e10adc3949ba59abbe56e057f20f883e', '8', '网招部', '马云', '2018-05-29 22:22:11', '69', '专员1', '1-35-36-37-38-44-50', '5');
INSERT INTO `user` VALUES ('51', 'mahuateng', 'e10adc3949ba59abbe56e057f20f883e', '8', '网招部', '马化腾', '2018-05-29 22:22:28', '69', '专员1', '1-35-36-37-38-44-51', '5');
INSERT INTO `user` VALUES ('52', 'aa', 'e10adc3949ba59abbe56e057f20f883e', '9', '销售部', '123', '2018-05-30 01:09:47', '68', '招聘专员', '1-52', '5');
INSERT INTO `user` VALUES ('54', 'zhouxin', 'e10adc3949ba59abbe56e057f20f883e', '11', '大客户部', '周鑫', '2018-05-30 01:42:24', '73', '大客户部总经理', '1-35-54', '8');
INSERT INTO `user` VALUES ('55', 'yangchen', 'e10adc3949ba59abbe56e057f20f883e', '12', '苏州交付中心', '杨晨', '2018-05-30 01:42:45', '72', '苏州交付中心总监', '1-35-55', '8');
INSERT INTO `user` VALUES ('56', 'zhangchangming', 'e10adc3949ba59abbe56e057f20f883e', '10', '蓝打网', '张长明', '2018-05-30 01:43:24', '74', '蓝打网总经理', '1-35-56', '8');
INSERT INTO `user` VALUES ('57', 'dingkai', 'e10adc3949ba59abbe56e057f20f883e', '11', '大客户部', '丁凯', '2018-05-30 02:14:09', '75', '大客户运营一部总监', '1-35-54-57', '7');
INSERT INTO `user` VALUES ('58', 'wangyan', 'e10adc3949ba59abbe56e057f20f883e', '11', '大客户部', '王燕', '2018-05-30 02:14:29', '76', '大客户运营二部总监', '1-35-54-58', '7');
INSERT INTO `user` VALUES ('59', 'hujing', 'e10adc3949ba59abbe56e057f20f883e', '11', '大客户部', '胡静', '2018-05-30 02:14:45', '77', '大客户运营三部总监', '1-35-54-59', '7');
INSERT INTO `user` VALUES ('60', 'jjj', 'e10adc3949ba59abbe56e057f20f883e', '12', '苏州交付中心', '急急急', '2018-05-30 02:31:18', '80', '经理1', '1-35-55-60', '7');
INSERT INTO `user` VALUES ('61', '0531', 'e10adc3949ba59abbe56e057f20f883e', '12', '苏州交付中心', '0531', '2018-05-30 21:12:01', '84', '招聘专员-交', '1-35-55-61', '7');
