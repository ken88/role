      ...
      <div class="span12">
        ...
        <div class="portlet box blue">
          ...
          <div class="portlet-body form">
            <form action="/module/add-save" class="form-horizontal">
              <input type="hidden" value="<?php echo $pid;?>" name="pid" />
              <div class="control-group">
                <label class="control-label">菜单名</label>
                <div class="controls">
                  <input type="text" ck="required" name="moduleName" placeholder="菜单名"  class="span6 m-wrap" />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">路径</label>
                <div class="controls">
                  <input type="text" ck="required" name="url" placeholder="路径"  class="span6 m-wrap" />
                </div>
              </div>
              <div class="control-group">
