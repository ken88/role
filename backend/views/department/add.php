      ...
      <div class="span12">
        ...
        <div class="portlet box blue">
          ...
          <div class="portlet-body form">
            <form action="/department/add" class="form-horizontal">
              <div class="control-group">
                <label class="control-label">部门名</label>
                <div class="controls">
                  <input type="text" ck="required" name="departmentName" placeholder="部门名"  class="span6 m-wrap" />
                </div>
              </div>
