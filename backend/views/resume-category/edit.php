            ...
            <div class="span12">
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-body form">
                        <form action="/resume-category/edit" class="form-horizontal">
                            <input type="hidden" value="<?php echo $info['id'];?>" name="id" />
                            <div class="control-group">
                                <label class="control-label">分类名</label>
                                <div class="controls">
                                    <input type="text" ck="required" name="cName" value="<?=$info['cName']?>" placeholder="分类名"  class="span6 m-wrap" />
                                </div>
                            </div>
